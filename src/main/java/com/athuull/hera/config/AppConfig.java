...
public class AppConfig {
    ...
    @Bean(name = "heraTaskExecutor")
    public ThreadPoolTaskExecutor heraTaskExecutor() {
        ThreadPoolTaskExecutor executor = new ThreadPoolTaskExecutor();
        executor.setCorePoolSize(4);
        executor.setMaxPoolSize(8);
        executor.setQueueCapacity(50);
        executor.setThreadNamePrefix("hera-worker-");
        executor.initialize();
        return executor;
    }
    ...
    public ThreadPoolTaskScheduler taskScheduler() {
        ...
        scheduler.setThreadNamePrefix("hera-scheduler-");
        return scheduler;
    }
}